...
from Staff.views import doctor_login_view, nurse_detail_view, nurse_login_view,lab_technician_detail_view, lab_technician_login_view, specialist_detail_view, gp_detail_view, stat_view, gp_account_information_view, specialist_account_information_view, nurse_account_information_view, lab_technician_account_information_view
