...
100004	aleen52@hotmail.com           	Mohammad Carroll    	553-70305-590650	(329)802-0740
...
SELECT pg_catalog.setval('public.patient_id_seq', 100048, true);
...
SELECT pg_catalog.setval('public.prescription_prescriptionid_seq', 10004, true);
