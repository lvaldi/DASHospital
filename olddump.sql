...
ALTER SEQUENCE public.STAFF_ID_seq RESTART WITH 1000;

CREATE TABLE public.DOCTOR (
ID INT NOT NULL,
AvailableForEmergency  BIT NULL,
PRIMARY KEY (ID),
FOREIGN KEY (ID) REFERENCES public.STAFF(ID)
          ON DELETE CASCADE);
...
ID INT NOT NULL,
PRIMARY KEY (ID),
FOREIGN KEY (ID) REFERENCES public.DOCTOR(ID)
          ON DELETE CASCADE);
...
FOREIGN KEY (ID) REFERENCES public.STAFF(ID)
ON DELETE CASCADE,
FOREIGN KEY (DID) REFERENCES public.DOCTOR(ID)
ON DELETE CASCADE);
...
FOREIGN KEY (ID) REFERENCES public.STAFF(ID)
ON DELETE CASCADE,
FOREIGN KEY (FID) REFERENCES public.Facility(ID) 
ON DELETE CASCADE);
...
PRIMARY KEY (ID),                                            
FOREIGN KEY (SID) REFERENCES public.STAFF(ID)
ON DELETE CASCADE);
...
FOREIGN KEY (WID) REFERENCES public.WeeklySchedule(ID)
ON DELETE CASCADE);
...
FOREIGN KEY (PID) REFERENCES public.Patient(ID)
          ON DELETE CASCADE,
FOREIGN KEY (DID) REFERENCES public.Doctor(ID)
          ON DELETE CASCADE); 
...
ALTER SEQUENCE public.Appointment_AppointmentID_seq RESTART WITH 10000000;
...
FOREIGN KEY (FID) REFERENCES public.Facility(ID),
FOREIGN KEY (AppointmentID) REFERENCES public.Appointment(AppointmentID));
...
FOREIGN KEY (DID) REFERENCES public.Doctor(ID),
FOREIGN KEY (PID) REFERENCES public.Patient(ID),
FOREIGN KEY (PrescriptionID) REFERENCES public.Prescription(PrescriptionID));
...
ALTER SEQUENCE public.Patient_ID_seq RESTART WITH 100000;
...
ALTER SEQUENCE public.Prescription_PrescriptionID_seq RESTART WITH 10000;
...
FOREIGN KEY (PrescriptionID) REFERENCES public.Prescription(PrescriptionID),
FOREIGN KEY (DIN) REFERENCES public.Medicine(DIN));
